...
template<typename Elem, typename A = allocator<Elem*>>
class ovector : public pvector<Elem*, A> {
public:
	Elem& operator[](int n) { return *this->at(n); }
	const Elem& operator[](int n) const { return *this->at(n); } // unchecked access
};
