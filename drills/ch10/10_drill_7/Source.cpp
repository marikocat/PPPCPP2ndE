...
int main()
{
	try {
		...
		ost << original_points;
		// we want to read from the same file we just wrote to
		// so we need to close this file first
		// explicitly, because ost will not be yet out of scope
		ost.close();
		...
		get_points(ist, processed_points, points_number);
